#include "gemqc8/Geometry/interface/GEMNumberingScheme.h"
...
using namespace QC8;
GEMNumberingScheme::GEMNumberingScheme( const QC8::MuonDDDConstants& muonConstants ) {
  initMe(muonConstants);
}

GEMNumberingScheme::GEMNumberingScheme( const DDCompactView& cpv ){
  QC8::MuonDDDConstants muonConstants(cpv);
  initMe(muonConstants);
}

void GEMNumberingScheme::initMe ( const QC8::MuonDDDConstants& muonConstants ) {
