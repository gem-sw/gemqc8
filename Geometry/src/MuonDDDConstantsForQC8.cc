...
//#define LOCAL_DEBUG
QC8::MuonDDDConstants::MuonDDDConstants( const DDCompactView& cpv ) {
#ifdef LOCAL_DEBUG
...
int QC8::MuonDDDConstants::getValue( const std::string& name ) const {
#ifdef LOCAL_DEBUG
...
void QC8::MuonDDDConstants::addValue(const std::string& name, const int& value) {
